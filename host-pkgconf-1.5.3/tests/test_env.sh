...
selfdir="/opt/mscc/mscc-brsdk-source-2019.02.7-232/mscc_stage1_servalt_defconfig/build/host-pkgconf-1.5.3/tests"
...
prefix="/opt/mscc/mscc-brsdk-source-2019.02.7-232/mscc_stage1_servalt_defconfig/host"
exec_prefix="${prefix}"
